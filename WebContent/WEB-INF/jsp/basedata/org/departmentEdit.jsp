		 	...
		 	<div class="mainword">
		 		<div class="mainaddword" style="border:solid 1px white">
		 			<ul class="EMtree_word fl" style="width: 55%;">
		 				...
		 				<li>
		 					<div class="fl mainaddword_name">是否车间：</div>
		 					<div >是<input type="radio" id="isworkshop" name="isworkshop" <c:if test="${aaDepartment.isWorkshop==0}">checked="checked"</c:if> value="0">
		 					否<input type="radio" id="isworkshop" name="isworkshop" <c:if test="${aaDepartment.isWorkshop==1}">checked="checked"</c:if> value="1"></div>
		 					<div class="cf"></div>
		 				</li>
