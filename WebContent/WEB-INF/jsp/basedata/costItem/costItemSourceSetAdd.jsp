...
function saveProcess(){
	$.ajax({
		...
		type: 'POST',
		url: '${ctx}/wms/costItem_addcostItemSourceSet.emi',
	...
	<form action="" method="post"  class="myform" id="myform" onsubmit="return checkdata()">
		...
		<!--按钮部分-->
	 	...
	 	<div class="creattable">
	 		<div class="tabletitle">新增成本项目取数</div>		 		
	 		<div class="xz_attribute">
	 			<ul>
	 				...
	 				<li>
	 					...
	 					<div style="width:50%;text-align:left;" class="fl">
		 					<textarea name="rdStyleName" id="rdStyleName"  style="width:260px; height: 80px;resize: none;" readonly="readonly" onclick="showRdStyle()"></textarea>
		                    <input type="hidden" name="rdStyleGid" id="rdStyleGid" value="">
		 				</div>
	 					<div class="cf"></div>
	 				</li>
	 				...
	 				<li>
						<div style="width:45%;text-align:right;" class="fl"><span  style="color: red;"></span>科目编码：</div>
	 					<div style="width:50%;text-align:left;" class="fl">
							<input type="text" id="subjectCode" name="subjectCode" class="toDealInput"  style="width:260px;height:25px;line-height: 25px;">
						</div>
							<div class="cf"></div> 
		 			</li>
		 			<li>
