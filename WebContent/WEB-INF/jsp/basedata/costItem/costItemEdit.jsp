...
function saveProcess(){
	$.ajax({
		...
		type: 'POST',
		url: '${ctx}/wms/costItem_updatecostItem.emi',
...
<body>
	<form method="post"  class="myform" id="myform" onsubmit="return checkdata()">
		<input type="hidden" name="costItemId" id="costItemId" value="${costItem.gid }">
		...
		<!--按钮部分-->
	 	...
	 	<div class="creattable">
	 		<div class="tabletitle">修改成本项目</div>		 		
	 			...
	 			<ul>
	 				<li>
	 					...
	 					<div style="width:50%;text-align:left;" class="fl">
	 						<input type="text" class="inputxt" style="width:260px;height:25px;line-height: 25px;" name="costItemCode" id="costItemCode" maxlength="20" value="${costItem.code}"/>
	 					</div>
	 					<div class="cf"></div>
	 				</li>
	 				<li>
	 					...
	 					<div style="width:50%;text-align:left;" class="fl">
	 						<input type="text" class="inputxt" style="width:260px;height:25px;line-height: 25px;" name="costItemName" id="costItemName" maxlength="50" value="${costItem.name}"/>
	 					</div>
	 					<div class="cf"></div>
	 				</li>
	 				<li>
						<div style="width:45%;text-align:right;" class="fl"><span  style="color: red;">*</span>成本类型：</div>
	 					<div style="width:50%;text-align:left;" class="fl">
							<input type="text" id="priorattributeName" name="priorattributeName" class="toDealInput" readonly style="width:260px;height:25px;line-height: 25px;" onclick="selectpriorattribute()" value="${prior['name']}">
							<input type="hidden" id="priorattributeGid" name="priorattributeGid" value="${prior['gid']}"> 
						</div>
							<div class="cf"></div> 
		 				</li>
		 				<li>
						<div style="width:45%;text-align:right;" class="fl"><span  style="color: red;">*</span>成本要素分配率：</div>
	 					<div style="width:50%;text-align:left;" class="fl">
							<input type="text" id="allotRateName" name="allotRateName" class="toDealInput" readonly style="width:260px;height:25px;line-height: 25px;" onclick="selectpriorattributes()" value="${priors['name']}">
	 				...
	 				<%-- <li>
	 					...
	 					<div style="width:50%;text-align:left;" class="fl">
	 						<input type="text" style="width:260px;height:25px;line-height: 25px;" name="costItemStyle" id="costItemStyle" value="${costItem.costItemstyle}" maxlength="20">
	 					</div>
	 					<div class="cf"></div>
	 				</li>
	 				<li>
	 					...
	 					<div style="width:50%;text-align:left;" class="fl">
	 						<input type="text" style="width:260px;height:25px;line-height: 25px;" name="costItemSpe" id="costItemSpe" value="${costItem.costItemspe}" maxlength="20">
	 					</div>
	 					<div class="cf"></div>
	 				</li> --%>
	 				<%-- <li>
	 					...
	 					<div style="width:50%;text-align:left;" class="fl">
	 						<input type="text" style="width:260px;height:25px;line-height: 25px;" name="workCenter" id="workCenter" value="${costItem.workcenter}"  maxlength="20">
	 					</div>
	 					<div class="cf"></div>
	 				</li> --%>
	 			</ul>
