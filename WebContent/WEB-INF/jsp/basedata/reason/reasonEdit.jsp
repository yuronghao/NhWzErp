...
function saveProcess(){
	$.ajax({
		...
		type: 'POST',
		url: '${ctx}/wms/reason_updatereason.emi',
...
<body>
	<form method="post"  class="myform" id="myform" onsubmit="return checkdata()">
		<input type="hidden" name="reasonId" id="reasonId" value="${reason.gid }">
	 			...
	 			<ul>
	 				<li>
	 					...
	 					<div style="width:50%;text-align:left;" class="fl">
	 						<input type="text" class="inputxt" style="width:260px;height:25px;line-height: 25px;" name="reasonCode" id="reasonCode" value="${reason.reasoncode}" maxlength="20"/>
	 					</div>
	 					<div class="cf"></div>
	 				</li>
	 				<li>
	 					...
	 					<div style="width:50%;text-align:left;" class="fl">
	 						<input type="text" class="inputxt" style="width:260px;height:25px;line-height: 25px;" name="reasonName" id="reasonName" value="${reason.reasonname}" maxlength="50"/>
	 					</div>
	 					<div class="cf"></div>
	 				</li>
	 				<%-- <li>
	 					...
	 					<div style="width:50%;text-align:left;" class="fl">
	 						<input type="text" style="width:260px;height:25px;line-height: 25px;" name="reasonStyle" id="reasonStyle" value="${reason.reasonstyle}" maxlength="20">
	 					</div>
	 					<div class="cf"></div>
	 				</li>
	 				<li>
	 					...
	 					<div style="width:50%;text-align:left;" class="fl">
	 						<input type="text" style="width:260px;height:25px;line-height: 25px;" name="reasonSpe" id="reasonSpe" value="${reason.reasonspe}" maxlength="20">
	 					</div>
	 					<div class="cf"></div>
	 				</li> --%>
	 				<%-- <li>
	 					...
	 					<div style="width:50%;text-align:left;" class="fl">
	 						<input type="text" style="width:260px;height:25px;line-height: 25px;" name="workCenter" id="workCenter" value="${reason.workcenter}"  maxlength="20">
	 					</div>
	 					<div class="cf"></div>
	 				</li> --%>
	 			</ul>
