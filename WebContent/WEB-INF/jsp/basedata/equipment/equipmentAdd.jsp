...
function saveProcess(){
	$.ajax({
		...
		type: 'POST',
		url: '${ctx}/wms/equipment_addequipment.emi',
	 			...
	 			<ul>
	 				<li>
	 					...
	 					<div style="width:50%;text-align:left;" class="fl">
	 						<input type="text" class="inputxt" style="width:260px;height:25px;line-height: 25px;" name="equipmentCode" id="equipmentCode" maxlength="20"/>
	 					</div>
	 					<div class="cf"></div>
	 				</li>
	 				<li>
	 					...
	 					<div style="width:50%;text-align:left;" class="fl">
	 						<input type="text" class="inputxt" style="width:260px;height:25px;line-height: 25px;" name="equipmentName" id="equipmentName" maxlength="50"/>
	 					</div>
	 					<div class="cf"></div>
	 				</li>
	 				<li>
	 					...
	 					<div style="width:50%;text-align:left;" class="fl">
	 						<input type="text" style="width:260px;height:25px;line-height: 25px;" name="SBL" id="SBL" maxlength="20">
	 					</div>
	 					<div class="cf"></div>
	 				</li>
	 				<!-- <li>
	 					...
	 					<div style="width:50%;text-align:left;" class="fl">
	 						<input type="text" style="width:260px;height:25px;line-height: 25px;" name="equipmentStyle" id="equipmentStyle" maxlength="20">
	 					</div>
	 					<div class="cf"></div>
	 				</li>
	 				<li>
	 					...
	 					<div style="width:50%;text-align:left;" class="fl">
	 						<input type="text" style="width:260px;height:25px;line-height: 25px;" name="equipmentSpe" id="equipmentSpe" maxlength="20">
	 					</div>
	 					<div class="cf"></div>
	 				</li> -->
	 				<li>
	 				...
	 				<li>
	 					...
	 					<div style="width:50%;text-align:left;" class="fl">
	 						<input type="text" style="width:260px;height:25px;line-height: 25px;" name="barcode" id="barcode" maxlength="20">
	 					</div>
	 					<div class="cf"></div>
	 				</li>
