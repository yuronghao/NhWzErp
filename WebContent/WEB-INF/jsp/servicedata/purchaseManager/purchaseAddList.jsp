...
<body>
<form action="${ctx}/wms/purchase_toAddpurchaseList.emi" name="myform" id="myform" method="post">
    <div class="EMonecontent">
        ...
        <div class="creattable">
            <div class="tabletitle">采购订单列表</div>
            <div>
                <table>
                    <tbody>
                    <tr>
                    ...
                    <c:forEach var="bean" items="${data.list}" varStatus="stat">
                        <tr>
                            ...
                            <td><a href="${ctx}/wms/purchase_toAddpurchase.emi?purchasegid=${bean.gid}">${bean.billcode}</a></td>
                            <td>${bean.goodsUid }</td>
                            ...
                            <td>${bean.providercustomercode }</td>
