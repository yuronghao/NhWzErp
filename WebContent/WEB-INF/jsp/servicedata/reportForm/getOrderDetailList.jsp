...
<link rel="stylesheet" type="text/css" href="${ctx}/css/emicom.css">
	...
	<body>
		<form action="${ctx}/wms/reportForm_getOrderDetailList.emi" name="myform" id="myform" method="post">
			<div class="EMonecontent">
				...
				<!--按钮部分-->
			 	...
			 	<div class="creattable">
			 		<div class="tabletitle">生产订单详细表</div>		 		
			 		<div>
			 			<table>
				 			<tbody>
				 				<tr>
				 				...
				 				<c:forEach var="bean" items="${data.list }" varStatus="stat">
									<tr>
										...
										<td nowrap class="longText" title="${bean.goodsUnitName }">${bean.goodsUnitName}</td>
										...
										<td nowrap class="longText" title="${bean.opname }">${bean.opname}</td>
