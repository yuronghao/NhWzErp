...
<body>
<form action="${ctx}/wms/wareHouse_othersOutList.emi" name="myform" id="myform" method="post">
		<div class="EMonecontent">
			...
			<!--按钮部分-->
		 	...
		 	<div class="creattable">
		 		<div class="tabletitle">其他出库单列表</div>
		 		<div>
		 			<table>
			 			<tbody>
			 				<tr>
							...
							<tr>
								...
								<td><a href="${ctx}/wms/wareHouse_toAddOthersOut.emi?otherOutgid=${bean.gid}">${bean.billCode}</a></td>
								<td>${bean.goodsUid }</td>
