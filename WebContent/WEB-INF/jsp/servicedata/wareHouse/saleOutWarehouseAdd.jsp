...
<script type="text/javascript">
		function checkForm()
		{
		   ...
		   if(document.getElementById('customerUid').value==""){
		...
		$(function(){
			...
			$('#saveBtn').click(function(){		
				...
				if(isSave){//新增保存			
					$.ajax({
						url:'${ctx}/wms/wareHouse_addSaleOutWarehouse.emi',
						type:"post",
						...
						success:function(da){
							...
							var obj=eval("("+da+")");
							if(obj.success==1){
								window.location.href = '${ctx}/wms/wareHouse_toAddSaleOutWarehouse.emi';
							}else{
					...
					$.ajax({
						url:'${ctx}/wms/wareHouse_updateSaleOutWarehouse.emi',
						type:"post",
						data:$('#myform').serialize(),
						success:function(da){					
							var obj=eval("("+da+")");
		...
		function deletesob(gid) {
			if (confirm("是否确定删除?")) {
				$.ajax({
							url : '${ctx}/wms/wareHouse_deleteSaleOutWarehouse.emi',
							type : 'post',
							data : {gid : gid},
							success : function(da) {	
		...
		//放弃
		function giveup() {
			location.href = '${ctx}/wms/wareHouse_toAddSaleOutWarehouse.emi';
		}
		
		
		function getprocurearrivallist(){
			window.location.href = '${ctx}/wms/wareHouse_saleOutWarehouseList.emi';
		}
...
<input type="hidden" id="saleOutWarehousegid" name="saleOutWarehousegid" value="${saleOutWarehouse['gid']}">
		 <div class="EMonecontent">
		 		...
		 		<ul>
		 			...
		 			<script>
		 				$(function() {
							 ...
							 */
							 var cond = "";
		 					initPageTurning('${ctx }/wms/wareHouse_toAddSaleOutWarehouse.emi','WM_SaleOut','gid',"${saleOutWarehouse['gid']}",
		 							cond,'saleOutWarehousegid');
		 				});
		 			</script>
		 			<!-- 单据翻页end -->
	 			</li>
		 	...
		 	<div class="creattable">
		 		<div class="tabletitle" style="margin-top:6px;">销售出库单</div>		 		
		 		<div>
		 			<!--12-->
		 			<ul class="wordul">
		 				<li class="wordli fl">
		 			...
		 			<li class="wordli fl">
						...
						<div class="wordnameinput fl">
							<input type="text" name="customerName" id="customerName" class="toDealInput" value="${customer.pcname}" >
	 						<input type="hidden" id="customerUid" name="customerUid" value="${saleOutWarehouse['customerUid']}" >
						</div>
						<div class="cf"></div>
					  </li>
					<li class="wordli fl">
		...
		<div  id="printdiv" style="display:none;">
			<div id="printhead" >
		 		<div class="tabletitle" style="margin-top:6px;;text-align:center;">销售出库单
		 		</div>
		 		...
		 		<div>
		 			...
		 			<ul class="wordul">
		 				<li class="wordli fl" style="list-style:none;float:left;width:30%;">
							...
							<div class="wordnameinput fl" style="float:left;"><input type="text" style="border:none;" value="${saleOutWarehouse['billCode']}" id="billCode" name="billCode" readonly="readonly"> </div>
							<div class="cf"></div> 
		 				</li>
		 				<li class="wordli fl" style="list-style:none;float:left;width:30%">
							<div class="wordname fl" style="float:left;">单据日期：</div>
							<div class="wordnameinput fl" style="float:left;"><input type="text" style="border:none;" value="${fn:substring(saleOutWarehouse['billDate'],0,10)}" id="billDate" name="billDate" readonly="readonly"> </div>
							<div class="cf"></div> 
		 				</li>
		 				<li class="wordli fl" style="list-style:none;float:left;width:30%">
		 			...
		 			<ul class="wordul">
		 				<li class="wordli fl" style="list-style:none;float:left;width:30%">
							<div class="wordname fl" style="float:left;">仓库：</div>
							<div class="wordnameinput fl" style="float:left;"><input type="text" style="border:none;" value="${warehouse.whname}" id="depName" name="depName" class="toDealInput"> </div>
							<div class="cf"></div> 
		 				</li>
		 				<li class="wordli fl" style="list-style:none;float:left;width:30%">
							<div class="wordname fl" style="float:left;text-align:right">客户：</div>
							<div class="wordnameinput fl" style="float:left"><input type="text" style="border:none;" value=""${customer.pcname}" id="notes" name="notes" class="toDealInput"> </div>
							<div class="cf"></div> 
		 				</li>
		 				<li class="wordli fl" style="list-style:none;float:left;width:32%">
							<div class="wordname fl" style="float:left">备注：</div>
							<div class="wordnameinput fl" style="float:left"><input type="text" style="border:none;" value="<fmt:formatNumber type="number" value="${saleOutWarehouse['notes']}" minFractionDigits="2"/>" id="notes" name="notes" class="toDealInput"> </div>
							<div class="cf"></div> 
		 				</li>
	 			...
	 			<table cellpadding="0" cellspacing="0" style="border:1px #ccc solid;margin-left:20px;width:95%;">
		 			<thead>
		 				<tr class="NO" style="border:1px #ccc solid;height:35px;line-height:35px;background-color:#e2eaf0;">
		 					...
		 					<!-- <th style="border-right:1px #ccc solid">备注</th> -->
		 				</tr>
		 			</thead>
		 			<tbody id="contr">
		 			<c:forEach var="type" items="${saleOutWarehouseC}" varStatus="stat">
	 		...
	 		<div style="margin-top:4%;" id="printfoot">
				<ul class="wordul">
	 				...
	 				<li class="wordli fl" style="list-style:none;float:left;width:32%">
						...
						<div class="wordnameinput fl" style="float:left"><input type="text" style="border:none;" value="${fn:substring(saleOutWarehouse['recordDate'],0,10)}" id="notes" name="notes" class="toDealInput"> </div>
						<div class="cf"></div> 
	 				</li>
	 				<div class="cf"></div> 
	 			</ul>
