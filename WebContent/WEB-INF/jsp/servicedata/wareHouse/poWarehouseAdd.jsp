...
<script type="text/javascript">
		...
		//放弃
		function giveup() {
			location.href = '${ctx}/wms/wareHouse_toAddPoWarehouse.emi';
		}
		
		
		function getprocurearrivallist(){
			window.location.href = '${ctx}/wms/wareHouse_powarehouseList.emi';
		}
...
<input type="hidden" id="poWarehousegid" name="poWarehousegid" value="${produceWarehouse['gid']}">
		 <div class="EMonecontent">
		 		...
		 		<ul>
		 			...
		 			<script>
		 				$(function() {
							 ...
							 */
							 var cond = "";
		 					initPageTurning('${ctx }/wms/wareHouse_toAddPoWarehouse.emi','WM_PoWarehouse','gid',"${produceWarehouse['gid']}",
		 							cond,'poWarehousegid');
		 				});
		 			</script>
		 			<!-- 单据翻页end -->
		 	...
		 	<div class="creattable">
		 		<div class="tabletitle" style="margin-top:6px;">采购入库单</div>		 		
		 		<div>
		 			<!--12-->
		 			<ul class="wordul">
		 				<li class="wordli fl">
