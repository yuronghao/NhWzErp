...
<body>
<form action="${ctx}/wms/wareHouse_powarehouseSalesReturnList.emi" name="myform" id="myform" method="post">
		<div class="EMonecontent">
			...
			<!--按钮部分-->
		 	...
		 	<div class="creattable">
		 		<div class="tabletitle">采购退货单列表</div>
		 		<div>
		 			<table>
			 			<tbody>
			 				<tr>
							...
							<tr>
								...
								<td><a href="${ctx}/wms/wareHouse_toAddPoWarehouseSalesReturn.emi?poWarehousegid=${bean.gid}">${bean.billcode}</a></td>
