...
<body>
<form action="${ctx}/wms/wareHouse_otherWarehouseList.emi" name="myform" id="myform" method="post">
		<div class="EMonecontent">
			...
			<!--按钮部分-->
		 	...
		 	<div class="creattable">
		 		<div class="tabletitle">其他入库单列表</div>		 		
		 		<div>
		 			<table>
			 			<tbody>
			 				<tr>
							...
							<tr>
								...
								<td><a href="${ctx}/wms/wareHouse_toAddOtherWarehouse.emi?otherWarehousegid=${bean.gid}">${bean.billCode}</a></td>
								<td>${bean.goodsUid }</td>
