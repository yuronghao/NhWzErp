...
<body>
<form action="${ctx}/wms/cost_getCostFeeMainList.emi" name="myform" id="myform" method="post">
		...
		<script type="text/javascript">
			function getDetail(obj){
				window.location.href="${ctx}/wms/cost_getCostFeeList.emi?mainGid="+$(obj).attr("gid");
			}
			...
			function getMethod(){
				...
				$.ajax({
					...
					type: 'POST',
					url: "${ctx}/wms/cost_getCostFee.emi",
					dataType:"JSON",
