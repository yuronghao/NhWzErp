...
<body>
<form action="${ctx}/wms/cost_getCostReportInInforMain.emi" name="myform" id="myform" method="post">
		<div class="EMonecontent">
			...
			<!--按钮部分-->
		 	...
		 	<div class="creattable">
		 		<div class="tabletitle">报工入库列表</div>		 		
		 		<div>
		 			<table>
			 			<tbody>
			 				<tr>
		...
		<script type="text/javascript">
			...
			function getDetail(obj){
				window.location.href="${ctx}/wms/cost_getReportProductInList.emi?mainGid="+$(obj).attr("gid");
			}
