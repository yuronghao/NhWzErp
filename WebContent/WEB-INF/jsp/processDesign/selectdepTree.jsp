		...
		<div id="content">
			<form action="" method="post" id="myform"  class="myform"  onsubmit="return checkdata()">
				...
				<!--内容部分-->
					...
					<div class="zTreeDemoBackground fl"  style="width: 100%;border:1px #ccc solid;margin-top:10px;margin-left:15%;overflow: auto">
...
document.getElementById("name").value = treeNode.depName;
document.getElementById("id").value = treeNode.gid;
}
