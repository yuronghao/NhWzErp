 ...
 * ================================自定义alert======================
 */
lhgdialog.alert_s = function( content, callback, parent )
{
	return lhgdialog({
		title: '系统提示',
	    drag: false,
...
lhgdialog.alert_e = function( content, callback, parent )
{
	return lhgdialog({
		title: '系统提示',
	    drag: false,
...
lhgdialog.alert_w = function( content, callback, parent )
{
	return lhgdialog({
		title: '系统提示',
	    drag: false,
