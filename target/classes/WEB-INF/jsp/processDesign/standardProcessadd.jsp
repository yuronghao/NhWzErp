	...
	<form action="" method="post"  class="myform" id="myform" onsubmit="return checkdata()">
		...
		<!--按钮部分-->
	 	...
	 	<div class="creattable">
	 		<div class="tabletitle">新增标准工序</div>		 		
	 			...
	 			<ul>
	 				<li>
	 					...
	 					<div style="width:50%;text-align:left;" class="fl">
	 						<input type="text" class="inputxt" style="width:260px;height:25px;line-height: 25px;" name="opcode" id="opcode" maxlength="20"/>
	 					</div>
	 					<div class="cf"></div>
	 				</li>
	 				<li>
	 					...
	 					<div style="width:50%;text-align:left;" class="fl">
	 						<input type="text" class="inputxt" style="width:260px;height:25px;line-height: 25px;" name="opname" id="opname" maxlength="50"/>
	 					</div>
	 					<div class="cf"></div>
	 				</li>
	 				<li>
	 					<div style="width:45%;text-align:right;" class="fl">是否质检：</div>
	 					<div style="width:50%;text-align:left;" class="fl">
	 						<input type="radio" class="inputxt" name="isCheck" value="1" />是
	 						<input type="radio" class="inputxt" name="isCheck" value="0" checked="checked"/>否
	 					</div>
	 					<div class="cf"></div>
	 				</li>
	 				<li>
	 					...
	 					<div style="width:50%;text-align:left;" class="fl">
	 						<input type="radio" class="inputxt" name="isMustScanMould" value="1" />是
	 						<input type="radio" class="inputxt" name="isMustScanMould" value="0" checked="checked"/>否
	 					</div>
	 					<div class="cf"></div>
	 				</li>
	 				<li>
	 					...
	 					<div style="width:50%;text-align:left;" class="fl">
	 						<input type="text" style="width:260px;height:25px;line-height: 25px;" name="checkRate" id="checkRate" maxlength="50"/>
	 					</div>
	 					<div class="cf"></div>
	 				</li>
	 				<li>
	 					...
	 					<div style="width:50%;text-align:left;" class="fl">
	 						<input type="radio" class="inputxt" name="isStock" value="1" />是
	 						<input type="radio" class="inputxt" name="isStock" value="0" checked="checked"/>否
	 					</div>
	 					<div class="cf"></div>
	 				</li>
	 				<li>
	 					...
	 					<div style="width:50%;text-align:left;" class="fl">
	 						<input type="text" style="width:260px;height:25px;line-height: 25px;" name="standardPrice" id="standardPrice" maxlength="50"/>
	 					</div>
	 					<div class="cf"></div>
	 				</li>
	 			</ul>
