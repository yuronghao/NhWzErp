...
function saveProcess(){
	if(checkForm()){
		$.ajax({
			...
			type: 'POST',
			url: '${ctx}/wms/basepd_updateWorkCenter.emi',
...
<body>
	<form method="post"  class="myform" id="myform" onsubmit="return checkdata()">
		<input type="hidden" name="workcenterid" id="workcenterid" value="${workcenter.gid }">
		...
		<!--按钮部分-->
	 	...
	 	<div class="creattable">
	 		<div class="tabletitle">修改工作中心</div>		 		
	 			...
	 			<ul>
	 				<li>
	 					...
	 					<div style="width:50%;text-align:left;" class="fl">
	 						<input type="text" class="inputxt" style="width:260px;height:25px;line-height: 25px;" name="wccode" id="wccode" value="${workcenter.wccode}" maxlength="20"/>
	 					</div>
	 					<div class="cf"></div>
	 				</li>
	 				<li>
	 					...
	 					<div style="width:50%;text-align:left;" class="fl">
	 						<input type="text" class="inputxt" style="width:260px;height:25px;line-height: 25px;" name="wcname" id="wcname" value="${workcenter.wcname}"  maxlength="50"/>
	 					</div>
	 					<div class="cf"></div>
	 				</li>
	 				<li>
	 					...
	 					<div style="width:50%;text-align:left;" class="fl">
	 						...
	 						<input type="hidden" id="depUid" name="depUid" value="${workcenter.depUid}" >
	 					</div>
	 					<div class="cf"></div>
	 				</li>
	 			</ul>
