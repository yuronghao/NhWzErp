...
<body>
<form action="${ctx}/wms/wareHouse_produceWarehouseList.emi" name="myform" id="myform" method="post">
		<div class="EMonecontent">
			...
			<!--按钮部分-->
		 	...
		 	<div class="creattable">
		 		<div class="tabletitle">生产入库单列表</div>		 		
		 		<div>
		 			<table>
			 			<tbody>
			 				<tr>
							...
							<tr>
								...
								<td><a href="${ctx}/wms/wareHouse_toAddProduceWarehouse.emi?produceWarehousegid=${bean.gid}">${bean.billcode}</a></td>
								<td>${bean.goodsGid }</td>
