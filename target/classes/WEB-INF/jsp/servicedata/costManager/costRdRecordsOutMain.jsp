...
<body>
<form action="${ctx}/wms/cost_getCostRdRecordsOutMain.emi" name="myform" id="myform" method="post">
		<div class="EMonecontent">
			<div style="width: 100%;height: 15px;"></div>
			<!--按钮部分-->
		 	<div class="toolbar">
		 		<ul>
		 			<input type="text" id="startDate" name="startDate" placeholder="取数期间" class="write_input Wdate" onclick="WdatePicker({dateFmt:'yyyy-MM'})" readonly="readonly" style="width: 100px" value="${startDate }" >
		 	...
		 	<div class="creattable">
		 		<div class="tabletitle">物料领用列表</div>		 		
		 		<div>
		 			<table>
			 			<tbody>
			 				<tr>
		...
		<script type="text/javascript">
			function getDetail(obj){
				window.location.href="${ctx}/wms/cost_getRdRecordsOutList.emi?mainGid="+$(obj).attr("gid");
			}
			...
			function getMethod(){
				...
				$.ajax({
					...
					type: 'POST',
					url: "${ctx}/wms/cost_getCostRdRecordsOut.emi",
					dataType:"json",
