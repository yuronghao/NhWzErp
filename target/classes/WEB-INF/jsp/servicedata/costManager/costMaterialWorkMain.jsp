...
<body>
<form action="${ctx}/wms/cost_getCostMaterialWorkMain.emi" name="myform" id="myform" method="post">
		...
		<script type="text/javascript">
			...
			function getDetail(obj){
				window.location.href="${ctx}/wms/cost_getCostMaterialWorkList.emi?mainGid="+$(obj).attr("gid");
			}
