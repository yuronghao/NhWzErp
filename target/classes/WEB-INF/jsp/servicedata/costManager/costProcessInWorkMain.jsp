...
<body>
<form action="${ctx}/wms/cost_getCostProcessInWorkMain.emi" name="myform" id="myform" method="post">
		<div class="EMonecontent">
			...
			<!--按钮部分-->
		 	...
		 	<div class="creattable">
		 		<div class="tabletitle">工序在制列表</div>		 		
		 		<div>
		 			<table>
			 			<tbody>
			 				<tr>
		...
		<script type="text/javascript">
			...
			function getDetail(obj){
				window.location.href="${ctx}/wms/cost_getCostProcessInWorkList.emi?mainGid="+$(obj).attr("gid");
			}
