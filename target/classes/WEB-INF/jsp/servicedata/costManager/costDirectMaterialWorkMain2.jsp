...
<body>
<form action="${ctx}/wms/cost_getCostDirectMaterialWorkMain2.emi" name="myform" id="myform" method="post">
		<div class="EMonecontent">
			...
			<!--按钮部分-->
		 	...
		 	<div class="creattable">
		 		<div class="tabletitle">材料2在制</div>		 		
		 		<div>
		 			<table>
			 			<tbody>
			 				<tr>
		...
		<script type="text/javascript">
			...
			function getDetail(obj){
				window.location.href="${ctx}/wms/cost_getCostDirectMaterialWorkList2.emi?mainGid="+$(obj).attr("gid");
			}
