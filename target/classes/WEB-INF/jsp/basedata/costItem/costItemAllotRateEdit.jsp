...
<script type="text/javascript">
	...
	$(function (){
		...
		initGoodsSelectsa("${costItem.goodsGid}",'${costItem.goodsCode}','${costItem.goodsName}','${costItem.cfree1}');
	})
	...
	function saveProcess(){
		$.ajax({
			...
			type: 'POST',
			url: '${ctx}/wms/costItem_UpdatecostItemAllotRate.emi',
...
function initGoodsSelectsa(goods_gid,goods_code,free1,cfree1){
		...
		success:function(data){		
			if(data.success=='1'){
				...
				for(var i=0;i<basPartArray.length;i++){
					...
					if(basPartArray[i].free1==cfree1){
	...
	<input type="hidden" name="costItemId" id="costItemId" value="${costItem.gid }">
		...
		<!--按钮部分-->
	 	...
	 	<div class="creattable">
	 		<div class="tabletitle">修改成本项目分配率</div>		 		
	 			...
	 			<ul>
	 				...
	 				<li>
	 					...
	 					<div style="width:50%;text-align:left;" class="fl">
	 						...
	 						<input type="text" class="inputxt" style="width:260px;height:25px;line-height: 25px;" readOnly name="goodsName" id="goodsName" maxlength="50" value="${costItem.goodsName }" onclick="fn_chooseGoods()"/>
	 						<input type="hidden" class="inputxt" name="goodsId" id="goodsId" maxlength="50" value="${costItem.goodsGid }"/>
	 					</div>
	 					<div class="cf"></div>
	 				</li>
	 				<li>
		 			...
		 			<li>
						<div style="width:45%;text-align:right;" class="fl"><span  style="color: red;">*</span>部门：</div>
	 					<div style="width:50%;text-align:left;" class="fl">
							<input type="text" id="depName" name="depName" class="toDealInput"  style="width:260px;height:25px;line-height: 25px;" onclick="fn_chooseDEPT()" value="${costItem.depName }" readOnly>
		 			...
		 			<li>
						<div style="width:45%;text-align:right;" class="fl"><span  style="color: red;">*</span>系数：</div>
	 					<div style="width:50%;text-align:left;" class="fl">
							<input type="text" id="ratio" name="ratio" class="toDealInput"  style="width:260px;height:25px;line-height: 25px;" value="${costItem.ratio }"  >
						</div>
							<div class="cf"></div> 
		 			</li>
		 			<li>
