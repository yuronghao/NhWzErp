...
<script type="text/javascript">
	...
	//修改模具
	$(function() {
		$("#mouldstatus   option[value='${mould.mouldstatus}']").prop("selected","selected");
		$("#isreturn   option[value='${mould.isreturn}']").prop("selected","selected");
		$("#isShareOrver   option[value='${mould.isShareOrver}']").prop("selected","selected");
		if('${mould.mouldBeginTime!=""}'){
			$("#mouldBeginTime").val(("${mould.mouldBeginTime}").substring(0,10));
		}
		if('${mould.mouldScrapTime!=""}'){
			$("#mouldScrapTime").val(("${mould.mouldScrapTime}").substring(0,10));
		}
		if('${mould.storageTime!=""}'){
			$("#storageTime").val(("${mould.storageTime}").substring(0,10));
		}
		if('${mould.outTime!=""}'){
			$("#outTime").val(("${mould.outTime}").substring(0,10));
		}
		if('${mould.returnTime!=""}'){
			$("#returnTime").val(("${mould.returnTime}").substring(0,10));
		}
		if('${mould.shareOrverTime!=""}'){
			$("#shareOrverTime").val(("${mould.shareOrverTime}").substring(0,10));
		}
	...
	function saveProcess(){
		$.ajax({
			...
			type: 'POST',
			url: '${ctx}/wms/mould_updatemould.emi',
			async: true,
	...
	<div class="EMonecontent">
		...
		<form id="myform" method="post" action="" onsubmit="return checkdata()">
		 	...
		 	<div class="creattable">
		 		<div class="tabletitle">修改模具</div>		 		
		 		<div class="createdList" style="height:80%;">
		 			<!--12-->
		 			<ul class="wordul">
		 			
		 				<li class="wordli fl">
		 				<input type="hidden" value="${mould.gid}" id="mouldId" name="mouldId" >
							<div class="wordname fl">模具分类：</div>
							<div class="wordnameinput fl">
							<input type="text" value="${mouldStyle.classificationname}" id="mouldStyle" name="mouldStyle" readonly="readonly"> 
							<input type="hidden" value="${mould.mouldstyle}" id="mouldStyleId" name="mouldStyleId" > 
							</div>
							 <div class="fl">
		 				...
		 				<li class="wordli fl">
							...
							<div class="wordnameinput fl">
							<input type="text" value="${mould.mouldcode}" id="mouldCode" name="mouldCode"> 
							</div>
							<div class="cf"></div> 
		 				</li>
		 				...
		 				<li class="wordli fl">
							...
							<div class="wordnameinput fl">
								<input type="text" value="${mould.mouldname}" id="mouldName" name="mouldName" >
							 </div>
							<div class="cf"></div> 
		 				</li>
		 			...
		 			<ul class="wordul">
		 				...
		 				<li class="wordli fl">
							...
							<div class="wordnameinput fl">
								<input type="text" value="${mould.barcode}" id="barcode" name="barcode"> 
							</div>
			 			...
			 			<li class="wordli fl">
							...
							<div class="wordnameinput fl">
								<input type="text" value="${mould.multimodeOrder}" id="multimodeOrder" name="multimodeOrder">
							</div>
							<div class="cf"></div> 
		 				</li>
		 				...
		 				<li class="wordli fl">
							...
							<div class="wordnameinput fl">
								<input type="text" value="${mould.cdefine1}" id="cdefine1" name="cdefine1">
							</div>
							<div class="cf"></div> 
		 				</li>
		 			...
		 			<ul class="wordul">
		 				...
		 				<li class="wordli fl">
							...
							<div class="wordnameinput fl">
								<input type="text" value="${mould.partNumber}" id="partNumber" name="partNumber">
							</div>
							<div class="cf"></div> 
		 				</li>
		 				...
		 				<li class="wordli fl">
							...
							<div class="wordnameinput fl">
								<input type="text" value="${mould.partName}" id="partName" name="partName">
							</div>
							<div class="cf"></div> 
		 				</li>
		 				...
		 				<li class="wordli fl">
							...
							<div class="wordnameinput fl">
								<input type="text" value="${mould.mouldRatio}" id="mouldRatio" name="mouldRatio">
							</div>
							<div class="cf"></div> 
		 				</li>
		 			...
		 			<ul class="wordul">
		 				...
		 				<li class="wordli fl">
							...
							<div class="wordnameinput fl">
								<input type="text" value="${mould.cavity}" id="cavity" name="cavity">
							</div>
							<div class="cf"></div> 
		 				</li>
		 				...
		 				<li class="wordli fl">
							...
							<div class="wordnameinput fl">
								<input type="text" value="${mould.fileLocation}" id="fileLocation" name="fileLocation">
							</div>
							<div class="cf"></div> 
		 				</li>
		 				...
		 				<li class="wordli fl">
							...
							<div class="wordnameinput fl">
								<input type="text" value="${mould.position}" id="position" name="position">
							</div>
							<div class="cf"></div> 
		 				</li>
		 			...
		 			<ul class="wordul">
		 				...
		 				<li class="wordli fl">
							...
							<div class="wordnameinput fl">
								<input type="text" value="${mould.placingTooling}" id="placingTooling" name="placingTooling">
							</div>
							<div class="cf"></div> 
		 				</li>
		 				...
		 				<li class="wordli fl">
							...
							<div class="wordnameinput fl">
								<input type="text" value="${mould.preTooling}" id="preTooling" name="preTooling">
							</div>
							<div class="cf"></div> 
		 				</li>
		 				...
		 				<li class="wordli fl">
							...
							<div class="wordnameinput fl">
								<input type="text" value="${mould.mouldFlow}" id="mouldFlow" name="mouldFlow">
							</div>
							<div class="cf"></div> 
		 				</li>
		 			...
		 			<ul class="wordul">
		 				...
		 				<li class="wordli fl">
							...
							<div class="wordnameinput fl">
								<input type="text" value="${mould.dataCode}" id="dataCode" name="dataCode">
							</div>
							<div class="cf"></div> 
		 				</li>
		 				...
		 				<li class="wordli fl">
							...
							<div class="wordnameinput fl">
								<input type="hidden" value="${mould.currentDeptGid}" id="currentDeptGid" name="currentDeptGid">
								<input type="text" value="${currentDept.depname}" id="currentDeptName" name="currentDeptName" readonly="readonly">
							</div>
							<div class="fl">
		 			...
		 			<ul class="wordul">
		 				...
		 				<li class="wordli fl">
							...
							<div class="wordnameinput fl">
								<input type="text" value="${mould.notes}" id="notes" name="notes">
							</div>
							<div class="cf"></div> 
		 				</li>
		 			...
		 			<ul class="wordul">
		 				...
		 				<li class="wordli fl">
							...
							<div class="wordnameinput fl">
							<input type="text" value="${mould.texture}" id="texture" name="texture"> 
							</div>
							<div class="cf"></div> 
		 				</li>
		 				...
		 				<li class="wordli fl">
							...
							<div class="wordnameinput fl">
							<input type="text" value="${mould.size}" id="size" name="size" >
							</div>
							<div class="cf"></div> 
		 				</li>
		 				...
		 				<li class="wordli fl">
							...
							<div class="wordnameinput fl">
								<input type="text" value="${mould.cost}" id="cost" name="cost">
							</div>
							<div class="cf"></div> 
		 				</li>
		 			...
		 			<ul class="wordul">
		 				...
		 				<li class="wordli fl">
							...
							<div class="wordnameinput fl">
								<input type="text" value="${mould.processingUnit}" id="processingUnit" name="processingUnit">
							</div>
							<div class="cf"></div> 
		 				</li> 
		 				...
		 				<li class="wordli fl">
							...
							<div class="wordnameinput fl">
								<input type="text" value="${mould.mouldScrapReason}" id="mouldScrapReason" name="mouldScrapReason">
							</div>
							<div class="cf"></div> 
		 				</li> 
		 			...
		 			<ul class="wordul">
		 				...
		 				<li class="wordli fl">
							...
							<div class="wordnameinput fl">
								<input type="text" value="${mould.life}" id="life" name="life">
							</div>
							<div class="cf"></div> 
		 				</li>
		 				...
		 				<li class="wordli fl">
							...
							<div class="wordnameinput fl">
								<input type="text" value="${mould.addlife}" id="addlife" name="addlife">
							</div>
							<div class="cf"></div> 
		 				</li>
		 				...
		 				<li class="wordli fl">
							...
							<div class="wordnameinput fl">
								<input type="text" value="${mould.usedlife}" id="usedlife" name="usedlife">
							</div>
							<div class="cf"></div> 
		 				</li>
		 			...
		 			<ul class="wordul">
		 				...
		 				<li class="wordli fl">
							...
							<div class="wordnameinput fl">
								<input type="text" value="${mould.canuselife}" id="canuselife" name="canuselife">
							</div>
							<div class="cf"></div> 
		 				</li>
		 				...
		 				<li class="wordli fl">
							...
							<div class="wordnameinput fl">
								<input type="hidden" value="${mould.cutomerGid}" id="cutomerGid" name="cutomerGid">
								<input type="text" value="${customer.pcname}" id="cutomerName" name="cutomerName" readonly="readonly">
							</div>
							<div class="fl">
		 			...
		 			<ul class="wordul">
		 				...
		 				<li class="wordli fl">
							...
							<div class="wordnameinput fl">
							<input type="hidden" value="${mould.providerGid}" id="providerGid" name="providerGid">
							<input type="text" value="${provider.pcname}" id="providerName" name="providerName" readonly="readonly">	
							</div>
							<div class="fl">
		 				...
		 				<li class="wordli fl">
							...
							<div class="wordnameinput fl">
								<input type="text" value="${mould.openCost}" id="openCost" name="openCost">
							</div>
							<div class="cf"></div> 
		 				</li>
		 			...
		 			<ul class="wordul">
		 				...
		 				<li class="wordli fl">
							...
							<div class="wordnameinput fl">
								<input type="text" value="${mould.shareOrverTime}" id="shareOrverTime" name="shareOrverTime" readonly="readonly" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})">
							</div>
							<div class="cf"></div> 
		 				</li>
		 			...
		 			<ul class="wordul">
		 				...
		 				<li class="wordli fl">
							...
							<div class="wordnameinput fl">
								<input type="text" value="${mould.supplyunit}" id="supplyunit" name="supplyunit">
							</div>
							<div class="cf"></div> 
		 				</li>
